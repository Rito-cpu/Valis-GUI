...
from src.gui.views.columns.ui_left_column import Ui_LeftColumn
...
class PyLeftColumn(QWidget):
    ...
    def __init__(
        ...
        self._bttn_color = bttn_color
        self._bttn_color_hover = bttn_color_hover
        self._bttn_color_pressed = bttn_color_pressed
        ...
        # CONNECT SIGNALS
        self.bttn_close.clicked.connect(self.bttn_clicked)
        self.bttn_close.released.connect(self.bttn_released)

    # TITLE LEFT COLUMN EMIT SIGNALS
    def bttn_clicked(self):
        self.clicked.emit(self.bttn_close)

    def bttn_released(self):
        self.released.emit(self.bttn_close)
    ...
    def setup_ui(self):
        ...
        self.icon_layout.addWidget(self.icon, Qt.AlignmentFlag.AlignCenter, Qt.AlignmentFlag.AlignCenter)
        ...
        # BTN FRAME
        self.bttn_frame = QFrame()
        self.bttn_frame.setFixedSize(30,30)
        self.bttn_frame.setStyleSheet("background: none;")
        # CLOSE BUTTON
        self.bttn_close = PyLeftButton(
            self._parent,
            self._app_parent,
            tooltip_text = "Hide",
            dark_one = self._dark_one,
            bg_color = self._bttn_color,
            bg_color_hover = self._bttn_color_hover,
            bg_color_pressed = self._bttn_color_pressed,
        ...
        self.bttn_close.setParent(self.bttn_frame)
        self.bttn_close.setObjectName("bttn_close_left_column")

        # ADD TO TITLE LAYOUT
        self.title_bg_layout.addWidget(self.icon_frame)
        self.title_bg_layout.addWidget(self.title_label)
        self.title_bg_layout.addWidget(self.bttn_frame)
