...
class DirectoryWidget(QWidget):
    ...
    def _setup_widget(self):
        ...
        self.file_label.setStyleSheet(f'color: {self.themes["app_color"]["text_color"]}; font-size: {self._font_size}px;')
        ...
        sorted_label.setStyleSheet(f'color: {self.themes["app_color"]["text_color"]}; font-size: {self._font_size}px;')
