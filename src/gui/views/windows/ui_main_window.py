...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        self.right_app_frame.setObjectName('right_app_frame')
        ...
        # LEFT CONTENT
        self.content_area_left_frame = QFrame(parent=self.content_area_frame)
        ...
        QFrame#content_area_right_bg_frame {{
            border-radius: 8px;
            background-color: {self.themes["app_color"]["blue_bg"]};
        }}
        QFrame#content_area_right_bg_frame QLabel {{
